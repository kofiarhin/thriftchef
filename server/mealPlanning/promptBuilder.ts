...
import { PLAN_DAYS, type MealPlanRequest } from "./mealPlanTypes";
 ...
 */
const SYSTEM_PROMPT = `You are a UK budget meal-planning assistant for Aldi shoppers.
...
export function buildPrompt(
  ...
  const user = `Plan a ${PLAN_DAYS}-day Aldi meal plan.
